function [cvxStatus,pStarRelax,ZStar] = ...
    qcqprelaxation_truncated_ls_rddCstr_outlier(bearing1,bearing2,R_gt,t_gt,sanityCheck,quiet)
% See truncated_LS_update.pdf for the corresponding math derivation
% Difference between this function and the default truncated_ls is
% Q_aux_2 having (maybe) redundant constraints, leading to the running
% time of this function longer than the default.
