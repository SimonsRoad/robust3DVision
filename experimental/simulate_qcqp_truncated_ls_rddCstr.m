...
for itr=1:NUM_ITERATIONS
    ...
    if isnan(pStarRelax_QCQP)
        error('This case is unsolvable with QCQP, please resample!')
    end
...
%         end
    ...
    %% solve using QCQP L1 Norm relax
    [cvxStatus_TLS,pStarRelax_TLS,ZStar_TLS] = ...
    qcqprelaxation_truncated_ls_rddCstr(bearing1,bearing2,R_gt,t_gt,SANITY_CHECK,TLS_QUIET);
